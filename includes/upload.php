...
class  data_table {
  ...
  public $productPath = SITE_ROOT.DS.'..'.DS.'uploads/files';
 ...
 /*--------------------------------------------------------------*/
 /* Function for Process data_table file
 /*--------------------------------------------------------------*/
  public function process_data_table($academic_year,$menu_col){
    if(!empty($this->errors)){
        return false;
      }
    ...
    if(move_uploaded_file($this->fileTempPath,$this->productPath.'/'.$this->fileName))
    {
      ...
      if($this->insert_data_table($academic_year,$menu_col)){
...
/*--------------------------------------------------------------*/
/* Function for insert data_table image
/*--------------------------------------------------------------*/
  private function insert_data_table($academic_year,$menu_col){

         global $db;
         $sql  = "INSERT INTO data_table (file_name,academic_year,menu_col)";
         $sql .=" VALUES ";
         $sql .="(
...
/*--------------------------------------------------------------*/
/* Function for Delete data_table by id
/*--------------------------------------------------------------*/
   public function data_table_destroy($id,$file_name){
